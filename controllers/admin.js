...
const adminLogin = TryCatch(async (req, res, next) => {
    ...
    return res.status(200).cookie("Aalap-admin-token",token, {... cookieOptions, maxAge: 1000 * 60 * 15,

    }).json({
        success: true,
        messages: "Authenticated Successfully,Welcome Back",
    });
});
...
const getDashboardStats = TryCatch(async (req, res) => {
    ...
    const [groupsCount, usersCount, messagesCount, totalChatsCounts ] = await Promise.all([
